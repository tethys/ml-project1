...
betaLS_1 = leastSquaresGD(y_train, tX);
rmseTr_1 = computeCostRMSE(y_train, tX, betaLS_1);
fprintf(1,'RMSE using LeastSquares multi GD linear regression for the first fitting: %3.3f\n', rmseTr_1);

[meanTrainError_1, meanValidationError_1]= KfoldCV(K, tX, y_train, 'leastSquaresGD', alpha);
...
betaLS_2 = leastSquaresGD(y_train, tX);
rmseTr_2 = computeCostRMSE(y_train, tX, betaLS_2);
fprintf(1,'RMSE using LeastSquares multi GD linear regression for the second fitting: %3.3f\n', rmseTr_2);

[meanTrainError_2, meanValidationError_2]= KfoldCV(K, tX, y_train, 'leastSquaresGD', alpha);
